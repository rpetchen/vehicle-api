...
class CarController {
	...
	ResponseEntity<?> post(@Valid @RequestBody Car car) throws URISyntaxException {
		...
		carService.setPriceAndLocation(newCar,newCar.getId(), newCar.getLocation());
	...
	ResponseEntity<?> put(@PathVariable Long id, @Valid @RequestBody Car car) {
		...
		carService.setPriceAndLocation( updatedCar, updatedCar.getId(),  updatedCar.getLocation());
